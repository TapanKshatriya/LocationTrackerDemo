...
public class StuButton extends RelativeLayout {
    ...
    public void reset() {
        ...
        stuTxtLabel.setText("Swipe left to start shift");
//        stuImgThumb.setText(" >> ");
        stuBackground.setImageDrawable(context.getResources().getDrawable(R.drawable.stu_default_bg));
        if (listener != null) {
            listener.onLock();
        }
...
//                stuTxtLabel.setAlpha(1f - progress * ALPHA_MODIFIER);
                stuTxtLabel.setText("Swipe right to end shift");
//                stuImgThumb.setText(" << ");
                stuBackground.setImageDrawable(context.getResources().getDrawable(R.drawable.stu_right_bg));
            }

//            Log.e("sliderPosition", "sliderPosition ==> " + sliderPosition);
...
//            stuImgThumb.setBackgroundResource(resId);
        }
    }
